...
png(filename='C:/Users/mmartinezp5/Documents/testdir/exdata_data_NEI_data/plot3.png', width=800, height=500, units='px')
...
ggplot(data=MD, aes(x=year, y=log(Emissions))) + facet_grid(. ~ type) + guides(fill=F) +
  ...
  ggtitle('Emisión por Tipo en la ciudad de Baltimore, Maryland') +
